...
import org.example.model.cards.buildings.utils.BuildingEffect;
...
public class DuringRitualTest {
    ...
    void ritualImmunity_shamanicRitualTrigger_setsNoRitualLostPPTrue() {
        DuringRitual ritual = new DuringRitual(3, 2, 1, Optional.empty(), BuildingEffect.RITUAL_IMMUNITY);
    ...
    void ritualStarsBonus_shamanicRitualTrigger_setsExtraStarsTo3() {
        DuringRitual ritual = new DuringRitual(3, 2, 1, Optional.empty(), BuildingEffect.RITUAL_STARS_BONUS);
        ritual.activeEffect(Set.of(player), Trigger.SHAMANIC_RITUAL);
    ...
    void ritualDoublePP_shamanicRitualTrigger_setsShamanMultiplierTo2() {
        DuringRitual ritual = new DuringRitual(3, 2, 1, Optional.empty(), BuildingEffect.RITUAL_DOUBLE_PP);
        ritual.activeEffect(Set.of(player), Trigger.SHAMANIC_RITUAL);
