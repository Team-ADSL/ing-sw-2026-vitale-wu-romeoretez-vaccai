...
public class BuildingTest {
    ...
    private static class ConcreteBuilding extends Building {
        public ConcreteBuilding(String id, int endGamePP, int cost, int era, Optional<Integer> numPlayers) {
    ...
    void getId_returnsCorrectId() {
        Building b = new ConcreteBuilding("building_01", 5, 3, 1, Optional.empty());
