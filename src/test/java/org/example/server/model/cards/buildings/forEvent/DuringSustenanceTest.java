...
public class DuringSustenanceTest {
    ...
    void getTypeMultiplier_returnsCorrectType() {
        DuringSustenance building = new DuringSustenance("ds", 3, 2, 1, Optional.empty(), CardType.HUNTER);
    ...
    void activeEffect_sustenanceTrigger_noCardsOfType_setsDiscountToZero() {
        DuringSustenance building = new DuringSustenance("ds", 3, 2, 1, Optional.empty(), CardType.INVENTOR);
        building.activeEffect(Set.of(player), Trigger.SUSTENANCE);
    ...
    void activeEffect_sustenanceTrigger_differentTypeMultiplier_countsCorrectType() {
        ...
        player.getCards().get(CardType.INVENTOR).add(new Inventor("i1", Icon.BOAT, 1, Optional.empty()));
        player.getCards().get(CardType.INVENTOR).add(new Inventor("i2", Icon.ROPE, 1, Optional.empty()));
